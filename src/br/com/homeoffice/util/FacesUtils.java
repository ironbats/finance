...
public class FacesUtils {
    ...
    public static void addSuccessMessageComponent(String idComponente, String msg) {
    ...
    public static Object getAttribute(Object classe, String valorObjeto) {
        return FacesContext.getCurrentInstance().getApplication().getELResolver().getValue(FacesContext.getCurrentInstance().getELContext(), null, valorObjeto);
    }
